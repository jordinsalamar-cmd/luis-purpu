...
import { APP_DISPLAY_NAME, displayProviderName } from "../branding"
      ...
      description={() =>
        ({
          opencode: (
            <box gap={1}>
              <text fg={theme.textMuted}>
                {APP_DISPLAY_NAME} Zen gives you access to all the best coding models at the cheapest prices with a single API
                key.
              </text>
              <text fg={theme.text}>
          ...
          "opencode-go": (
            <box gap={1}>
              <text fg={theme.textMuted}>
                {APP_DISPLAY_NAME} Go is a $10 per month subscription that provides reliable access to popular open coding models
