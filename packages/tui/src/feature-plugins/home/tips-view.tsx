...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public LUIS-PURPU link",
  ...
  "Create {highlight}opencode.json{/highlight} for server settings, and {highlight}tui.json{/highlight} for the terminal",
  ...
  "Create a plugin to prevent LUIS-PURPU from reading sensitive files",
  "Use {highlight}luis run{/highlight} for non-interactive scripting",
  "Use {highlight}luis --continue{/highlight} to resume the last session",
  "Use {highlight}luis run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}luis serve{/highlight} for headless API access to LUIS-PURPU",
  "Use {highlight}luis run --attach{/highlight} to connect to a running server",
  "Run {highlight}luis upgrade{/highlight} to update to the latest version",
  "Run {highlight}luis auth list{/highlight} to see all configured providers",
  "Run {highlight}luis agent create{/highlight} for guided agent creation",
  "Use {highlight}/luis{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}luis github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/luis fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}luis debug config{/highlight} to troubleshoot configuration",
  ...
  "Ejecuta LUIS-PURPU en un contenedor Docker",
  "Use {highlight}/connect{/highlight} with LUIS-PURPU Zen for curated, tested models",
