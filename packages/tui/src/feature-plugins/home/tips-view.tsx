...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public Re:ZERO link",
  ...
  "Create a plugin to prevent Re:ZERO from reading sensitive files",
  ...
  "Run {highlight}luis serve{/highlight} for headless API access to Re:ZERO",
  ...
  "Ejecuta Re:ZERO en un contenedor Docker",
  "Use {highlight}/connect{/highlight} with Re:ZERO Zen for curated, tested models",
